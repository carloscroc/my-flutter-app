Design-It
# SaaS Product Design Brief - ReSpace Interior Design App
...
- Use Lucide (or similar) icons adapted for Flutter (SVGs or a Flutter icon package)
- Use Flutter's styling and theming system (`ThemeData`, responsive widgets). Do not prescribe web/CSS toolchains like Tailwind—deliver Flutter widgets and styles instead.
...
We are building a consumer-focused fitness and wellness mobile app that helps users plan and track workouts, log meals, manage a calendar of sessions, and engage with a supportive community. The product prioritizes clear information hierarchy, warm but minimal visual design, and fast, scannable screens to help users stay consistent with their health goals.
...
Make sure your outputs are Flutter widgets that can be rendered from the app's main root (for example, via `main.dart`) in this repository. Each screen should be its own contained widget/class (separate files preferred) for easier style adjustments.
