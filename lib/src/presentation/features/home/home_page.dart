...
class HomePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Stack(
      children: [
        if (kDebugMode) const TestBackground(),
        Scaffold(
                    ...
                    children: [
                        ...
                        child: featuredAsync.when(
                          data: (items) => SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (_, i) =>
                                  ItemFeaturedWorkouts(workout: items[i]),
                            ),
                          ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Align(
                                  ...
                                  child: Text('Help us assist you better',
                                      style: GoogleFonts.inter(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w500)),
                                ),
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 12.0),
                                child: Text(
                                    'Answer a few questions to get best from the app and achieve your goals faster.',
                                    style: GoogleFonts.inter(
                                        color: Colors.white70)),
                              ),
                              const SizedBox(height: 12),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            _CategoryChip(
                                iconAsset: 'assets/images/bodybuilding.svg',
                                label: 'Strength'),
                            const SizedBox(width: 12),
                            _CategoryChip(
                                iconAsset: 'assets/images/trademill.svg',
                                label: 'Cardio'),
                            const SizedBox(width: 12),
                            _CategoryChip(
                                iconAsset: 'assets/images/yoga.svg',
                                label: 'Yoga'),
                            const SizedBox(width: 12),
                            _CategoryChip(
                                iconAsset: 'assets/images/walk.svg',
                                label: 'Walking'),
                            const SizedBox(width: 12),
                            _CategoryChip(
                                iconAsset: 'assets/images/swimming.svg',
                                label: 'Swimming'),
                          ],
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Meditative Mornings',
                                style: GoogleFonts.inter(
                                    fontSize: 16, fontWeight: FontWeight.w600)),
                            TextButton(
                                onPressed: () => context.go('/meditative'),
                                child: const Text('See All')),
                          ],
                        ),
                      ),
                          ...
                          data: (items) => SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              separatorBuilder: (_, __) =>
                                  const SizedBox(width: 12),
                              itemBuilder: (_, i) =>
                                  ItemMeditiveVertical(meditation: items[i]),
                            ),
                          ),
                          loading: () => const SizedBox(
                              height: 160,
